...
function preencheTabela(){
    ...
    `<tr>
        ...
        <th class="tituloColuna">Complemento</th>
...
function descadastra(index){
    cadastros.splice(index,1);          //remove item selecionado do array;
    localStorage.setItem("cadastro", JSON.stringify(cadastros) );       //atualiza localStorage
    preencheTabela();
}
